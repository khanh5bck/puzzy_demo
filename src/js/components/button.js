...
// })
// https://medium.com/anvoevodin/flexible-ui-buttons-with-pixijs-v5-using-ninesliceplane-39234efa1507
...
export class Button extends PIXI.NineSlicePlane {
    constructor(settings) {
        ...
        this.label = new PIXI.Text('',{ wordWrap: true, wordWrapWidth: this.settings.width-5, wordWrapHeight: this.settings.height-5})
    ...
    update(settings) {
        ...
        this.label.style = {
            ...
            // wordWrap: true, 
            // wordWrapWidth: this.settings.width-10, 
            // wordWrapHeight: this.settings.height-10
        }
        if(this.label.width > this.settings.width){
            this.label.width = this.settings.width-20
        }
